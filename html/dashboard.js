...
window.addEventListener('message', function(event) {
    if (event.data.type === 'toggleDashboard') {
        ...
        document.getElementById('totalEarnings').textContent = `$${event.data.total_earnings || 0}`;

        // Update job list with new format
        ...
        // Update payouts list - Only show completed jobs
